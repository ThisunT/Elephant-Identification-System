...
describe('injectSheet', function () {
  ...
  describe('access inner element', function () {
    ...
    it('should forward the ref', function () {
      var innerComp = null;
      ...
      var InnerComponent = function (_React$PureComponent2) {
        _inherits(InnerComponent, _React$PureComponent2);

        function InnerComponent(props) {
          _classCallCheck(this, InnerComponent);

          var _this2 = _possibleConstructorReturn(this, (InnerComponent.__proto__ || Object.getPrototypeOf(InnerComponent)).call(this, props));

          _this2.isInnerComponent = true;
          return _this2;
        }
      ...
      var StyledComponent = injectSheet({})(InnerComponent);
      render(_react2['default'].createElement(StyledComponent, { ref: ref }), node);

      var expectedValue = _react2['default'].forwardRef ? true : undefined;
      (0, _expect2['default'])(innerComp.isInnerComponent).to.be(expectedValue);
    });
  });
