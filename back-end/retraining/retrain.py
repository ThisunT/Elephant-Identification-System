...
By default, this script will log summaries to /UCSC/3rd year/Project/My work/back-end/tmp/retrain_logs directory

Visualize the summaries with this command:

tensorboard --logdir /UCSC/3rd year/Project/My work/back-end/tmp/retrain_logs

To use with Tensorflow Serving:

```bash
tensorflow_model_server --port=9000 --model_name=inception \
    --model_base_path=/UCSC/3rd year/Project/My work/back-end/tmp/saved_models/
```
"""
...
CHECKPOINT_NAME = os.path.split(os.getcwd())[0]+'/back-end/tmp/_retrain_checkpoint'
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default=os.path.split(os.getcwd())[0]+'/tmp/output_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default=os.path.split(os.getcwd())[0]+'/tmp/intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default=os.path.split(os.getcwd())[0]+'/tmp/output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default=os.path.split(os.getcwd())[0]+'/tmp/retrain_logs',
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default=os.path.split(os.getcwd())[0]+'/tmp/imagenet',
      help="""\
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default=os.path.split(os.getcwd())[0]+'/tmp/bottleneck',
  ...
  parser.add_argument(
      '--saved_model_dir',
      type=str,
      default=os.path.split(os.getcwd())[0]+'/tmp/saved_models/1/',
...
#Code to use when retrain.py is running directly from the retraining derectory

# FLAGS = Namespace(architecture='inception_v3', bottleneck_dir=os.path.split(os.getcwd())[0]+'/back-end/tmp/bottleneck', eval_step_interval=10, final_tensor_name='final_result', flip_left_right=False, how_many_training_steps=4000, image_dir='dataset', intermediate_output_graphs_dir=os.path.split(os.getcwd())[0]+'/back-end/tmp/intermediate_graph/', intermediate_store_frequency=0, learning_rate=0.01, model_dir='inceptionV3', output_graph=os.path.split(os.getcwd())[0]+'/back-end/tmp/output_graph.pb', output_labels=os.path.split(os.getcwd())[0]+'/back-end/tmp/output_labels.txt', print_misclassified_test_images=False, random_brightness=0, random_crop=0, random_scale=0, saved_model_dir=os.path.split(os.getcwd())[0]+'/back-end/tmp/saved_models/1/', summaries_dir=os.path.split(os.getcwd())[0]+'/back-end/tmp/retrain_logs', test_batch_size=-1, testing_percentage=10, train_batch_size=100, validation_batch_size=100, validation_percentage=10)
# sys.argv = ['retrain.py', '--image_dir=dataset', '--model_dir=inceptionV3']
# unparsed = []
# tf.app.run(main=main, argv=[sys.argv[0]] + unparsed)
...
# def start_retrain():
#   FLAGS = Namespace(architecture='inception_v3', bottleneck_dir=os.path.split(os.getcwd())[0]+'/back-end/tmp/bottleneck', eval_step_interval=10, final_tensor_name='final_result', flip_left_right=False, how_many_training_steps=4000, image_dir=os.path.split(os.getcwd())[0]+'/back-end/retraining/dataset', intermediate_output_graphs_dir=os.path.split(os.getcwd())[0]+'/back-end/tmp/intermediate_graph/', intermediate_store_frequency=0, learning_rate=0.01, model_dir=os.path.split(os.getcwd())[0]+'/back-end/retraining/inceptionV3', output_graph=os.path.split(os.getcwd())[0]+'/back-end/tmp/output_graph.pb', output_labels=os.path.split(os.getcwd())[0]+'/back-end/tmp/output_labels.txt', print_misclassified_test_images=False, random_brightness=0, random_crop=0, random_scale=0, saved_model_dir=os.path.split(os.getcwd())[0]+'/back-end/tmp/saved_models/1/', summaries_dir=os.path.split(os.getcwd())[0]+'/back-end/tmp/retrain_logs', test_batch_size=-1, testing_percentage=10, train_batch_size=100, validation_batch_size=100, validation_percentage=10)
#   sys.argv = ['retrain.py', '--image_dir='+os.path.split(os.getcwd())[0]+'/back-end/retraining/dataset', '--model_dir='+os.path.split(os.getcwd())[0]+'/back-end/retraining/inceptionV3']
#   unparsed = []
#   tf.app.run(main=main, argv=[sys.argv[0]] + unparsed)


#Initially run the main method, with the arguments --image_dir=dataset --model_dir=inceptionV3. Then comment all the lines in the main program and uncomment start_retrain method.